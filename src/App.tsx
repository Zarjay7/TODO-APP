    ...
    <div className="min-h-screen bg-[var(--bg)] text-[var(--text)] flex flex-col">
      ...
      <header className="h-16 border-b border-[var(--border)] bg-[var(--surface)]/95 backdrop-blur-md sticky top-0 z-50 flex items-center px-4 md:px-6">
        ...
        <div className="relative w-full max-w-md mx-4 hidden md:block">
          <div className="absolute left-8 top-1/2 -translate-y-1/2 text-[var(--text-muted)]">
            <Search size={16} />
          </div>
          <input
            type="text"
            ...
            className="skeu-input w-full pl-16 pr-4 py-2 text-sm"
          />
        </div>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 p-3 border-t border-[var(--border)] bg-[var(--surface)] z-40">
        <div className="relative">
          <Search size={16} className="absolute left-8 top-3.5 text-[var(--text-muted)]" />
          <input
            type="text"
            value={searchQuery}
            onChange={(e) => setSearchQuery(e.target.value)}
            placeholder="Search tasks..."
            className="skeu-input w-full pl-16 text-sm py-3"
          />
        </div>
      </div>
    </div>
